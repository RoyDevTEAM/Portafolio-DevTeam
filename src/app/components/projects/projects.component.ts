...
export class ProjectsComponent implements OnInit {
  projects = [
    { filter: 'filter-1', title: 'Sistema de ventas', image: 'assets/img/proyect/img1.PNG', githubLink: 'https://deploy-sistema-venta.vercel.app/login' },
    { filter: 'filter-1', title: 'Tienda Online', image: 'assets/img/proyect/img2.PNG', githubLink: 'https://roydevteam.github.io/Angukar-deploy/home' },
    ...
    { filter: 'filter-3', title: 'JavaScript Game', image: 'assets/img/proyect/game1.PNG', githubLink: 'https://elias-cj.github.io/practica/' },
